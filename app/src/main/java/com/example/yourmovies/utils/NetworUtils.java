...
public class NetworUtils {
    ...
    //сохраняем значения
    private static final String API_KEY = "ff80ccefe4cbc087e4d046a46792b152";
    ...
    private static URL buildURL(int sortBy, int page) {
        ...
        //прикрепляем параметры Uri.parse-> buildUpon -> appendQuerry
    ...
    //создаем метод который получает JSON из сети
